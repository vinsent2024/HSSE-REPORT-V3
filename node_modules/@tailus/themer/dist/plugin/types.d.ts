...
import type { Palette } from "./../config/preconfigs/palette/types";
import type { Color, Info, Gray, Danger, Warning, Success, ColorShades } from "./../config/types";
import { AccordionConfig, AlertConfig, AnnonceConfig, AvatarConfig, BadgeConfig, ButtonConfig, CardConfig, FeedbackConfig, FieldConfig, FlagConfig, MenuConfig, PopoverConfig, SelectConfig, SwitchConfig, TabsConfig, ToastConfig, TooltipConfig, UiConfig } from "./../config/";
export type Config = {
    /**
